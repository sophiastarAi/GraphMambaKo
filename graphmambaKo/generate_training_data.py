...
def generate_train_val_test(args):
    ...
    # df = pd.read_hdf(args.filename) #(length, num of nodes)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--filename", type=str, default="data/combined_1819_hourly.csv", help="Raw traffic readings.",)
    parser.add_argument("--seq_length_x", type=int, default=96, help="Sequence Length.",)
    parser.add_argument("--seq_length_y", type=int, default=96, help="Sequence Length.",)
